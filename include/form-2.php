...
$toemails[] = array(
				'email' => 'info@womstr.com', // Your Email Address
				'name' => 'Womstr' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@womstr.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Womstr' // Company Name
			);
...
$mail->Port = 26;<br />
$mail->Username = “yourname@yourdomain.com”;<br />
$mail->Password = “yourpassword”;

// End of SMTP

/* Add your SMTP Gmail Codes after this Line */
$mail->isSMTP();<br />
$mail->SMTPDebug = 0;<br />
